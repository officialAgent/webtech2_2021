    ...
    <div class="profile-content">
        <div class="container">
            ...
            <div class="description text-center">
                <p>There are no mistakes, No coincidences. All events are blessings given to us to learn. A journey of a thousand miles started with only one step. Good Luck.</p>
            </div>
                                                    ...
                                                    <div id="show" style="color: #ffffee"  class="controls text-center">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group"> <input id=<?php echo $row['questionPosition']  ?> name=<?php echo $row['questionPosition']  ?> type="text"  class="form-control" placeholder="Please enter your ans " required="required" data-error="PLS fill out"> </div>
...
?>
                                                            ...
                                                            <div onclick="checkDragNDrop()" class="col-md-12"> <input type="submit" id="save" class="btn btn-success btn-send pt-2 btn-block " value="Save test"> </div>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
